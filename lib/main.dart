...
class _TemperatureConversionHomePageState extends State<TemperatureConversionHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Temperature Conversion App', style: TextStyle(color: Colors.white)),
        centerTitle: true,
        flexibleSpace: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [Color.fromARGB(255, 163, 193, 227), Color.fromARGB(255, 2, 35, 22)],
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [Colors.blue.shade300, const Color.fromARGB(255, 6, 54, 73)],
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
          ),
        ),
            ...
            children: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  foregroundColor: const Color.fromARGB(255, 170, 175, 179), backgroundColor: Colors.white,
